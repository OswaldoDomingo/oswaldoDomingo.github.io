...
### Frontend Mentor: componente de tarjeta de vista previa de 3 columnas
...
Tu tarea es construir el proyecto con los diseños dentro de la carpeta `/design`. Encontrará una versión móvil y otra de escritorio del diseño.
...
### Cree un `README.md` personalizado    
